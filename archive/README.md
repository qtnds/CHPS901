...
│   ├── analyse.py        Tableaux console + 13 figures PNG !écrite par ChatGPT!
│   └── run_cluster.sh    Script SBATCH
...
```bash
git clone  https://github.com/qtnds/CHPS901.git archive
cd archive
```
...
### Mode batch SBATCH (sans réservation préalable)
...
> trouvent en haut de `scripts/run_cluster.sh`.
